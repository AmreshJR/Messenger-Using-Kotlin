...
import com.amresh.messenger.AdaptorClasses.ChatsAdapter
import com.amresh.messenger.Fragments.APIService
import com.amresh.messenger.ModelClasses.Chat
import com.amresh.messenger.ModelClasses.Users
import com.amresh.messenger.Notifications.*
...
class MessageChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        send_message_btn.setOnClickListener {
            ...
            if(message == "")
            {
                Toast.makeText(this@MessageChatActivity, "Please type the message", Toast.LENGTH_LONG).show()
            }
            else
            {
        ...
        attach_image_file_btn.setOnClickListener {
            ...
            intent.type = "image/*"
            startActivityForResult(Intent.createChooser(intent,"Choose a file"), 438)
        }
    ...
    private fun sendMessageToUser(senderId: String, receiverId: String?, message: String)
    {
        ...
        //implement the push notifications using firebase cloud
                            ...
                            override fun onResponse(
                                ...
                                if(response.code() == 200)
                                {
                                    if(response.body()!!.success !== 1)
                                    {
                                        ...
                                        Toast.makeText(this@MessageChatActivity, "Failed, Nothing happened", Toast.LENGTH_LONG)
