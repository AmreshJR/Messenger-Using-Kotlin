...
import com.amresh.messenger.ViewFullImageActivity
import com.amresh.messenger.WelcomeActivity
...
) : RecyclerView.Adapter<ChatsAdapter.ViewHolder?>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder
    {
        ...
        {
            val view: View = LayoutInflater.from(mContext).inflate(com.amresh.messenger.R.layout.message_item_right,parent,false)
            ViewHolder(view)
        }
        else
        {
            val view: View = LayoutInflater.from(mContext).inflate(com.amresh.messenger.R.layout.message_item_left,parent,false)
            ViewHolder(view)
        }
    }
    ...
    private fun deleteSentMessage(position: Int, holder: ChatsAdapter.ViewHolder)
    {
        val ref = FirebaseDatabase.getInstance().reference.child("chats")
            ...
            .addOnCompleteListener { task ->
                ...
                {
                    Toast.makeText(holder.itemView.context,"Message is Deleted",Toast.LENGTH_SHORT).show()
                }
                else
                {
                    Toast.makeText(holder.itemView.context,"Message is Not Deleted",Toast.LENGTH_SHORT).show()
