package com.amresh.messenger.Notifications
...
class MyFirebaseMessaging : FirebaseMessagingService()
{
    ...
    private fun sendNotification(mRemoteMessage: RemoteMessage)
    {
        ...
        val sendNotification = getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        ...
        sendNotification.notify(i, builder.build())
    }
